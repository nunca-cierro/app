      ...
      <div className="mt-14 grid gap-8 md:grid-cols-2 md:items-start max-w-4xl mx-auto">
        ...
        <AnimatedWrapper direction="up" duration={0.5} delay={0.1}>
          <div className="space-y-5">
            {/* WhatsApp card */}
            <a
              href={siteWhatsAppMessages.landingUrl}
              target="_blank"
