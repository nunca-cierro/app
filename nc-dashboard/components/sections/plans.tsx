    ...
    >
      ...
      <div className="mt-14 max-w-4xl mx-auto">
        <AnimatedWrapper direction="up" duration={0.5}>
          <h3 className="text-center text-lg font-semibold text-stone-100 mb-6">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-stone-800/80">
                  <th className="text-left px-5 py-4 text-stone-400 font-medium">Característica</th>
                  <th className="text-center px-5 py-4 text-stone-300 font-semibold">Básico</th>
                  <th className="text-center px-5 py-4 text-amber-300 font-semibold">Profesional</th>
                  <th className="text-center px-5 py-4 text-stone-300 font-semibold">Empresarial</th>
                </tr>
              </thead>
              <tbody>
                {sitePlans.comparisonRows.map((row, i) => (
                  <tr key={row.label} className={i % 2 === 0 ? "bg-stone-900/40" : ""}>
                    <td className="px-5 py-3.5 text-stone-300">{row.label}</td>
                    <td className="px-5 py-3.5 text-center text-stone-400">{row.basic}</td>
                    <td className="px-5 py-3.5 text-center text-stone-200">{row.pro}</td>
                    <td className="px-5 py-3.5 text-center text-stone-200">{row.enterprise}</td>
                  </tr>
                ))}
              </tbody>
            </table>
