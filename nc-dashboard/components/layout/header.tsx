      ...
      >
        <div className="flex items-center justify-between h-20 px-4 sm:px-6">
          ...
          <nav className="hidden md:flex items-center gap-4 ml-auto">
            {/* Segmented Control - navegación entre servicios */}
            <div className="flex items-center rounded-lg border border-white/15 bg-white/5 p-0.5 mr-3">
              <a
                href="/pagina-web"
                className={cn(
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-white/70 bg-white px-6 py-2 text-[0.95rem] font-semibold text-stone-950 transition-all hover:shadow-[0_0_20px_rgba(242,191,39,0.35)] hover:-translate-y-0.5 shrink-0"
              style={{ letterSpacing: "0.01em" }}
            >
